...
export default function GridScan({
    ...
    useEffect(() => {
        ...
        const onClick = async () => {
            ...
            if (
                ...
                // @ts-ignore - Some older browsers don't have requestPermission on type
    ...
    useEffect(() => {
        ...
        // Explicitly typed DeviceOrientationEvent
